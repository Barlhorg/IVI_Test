...
public class FilmsPage extends TestBase {
    ...
    public static BestMovies clickOnBestMovies() {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@title='Премьеры фильмов']")));
        driver.findElement(By.xpath("//div[@title='Премьеры фильмов']")).click();
